...
class TextFieldItem<T> extends StatelessWidget {
  TextFieldItem({
    ...
    // this.prefix,
    // this.suffix,
    this.style = const TextStyle(fontSize: 15, color: Color(0xFF404040)),
    this.prefixStyle = const TextStyle(fontSize: 15, color: Color(0xFF404040)),
    this.suffixStyle = const TextStyle(fontSize: 15, color: Color(0xFF404040)),
